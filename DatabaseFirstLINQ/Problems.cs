...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        //    var containsAnS = products.Where(p => p.Name.Contains("S"));
        //    foreach(var target in containsAnS)
        //    {
        ...
        //var registeredDate = users.Where(u => u.RegistrationDate < date);
        //foreach (var user in registeredDate)
        //{
        //    Console.WriteLine(user.Email + " " + user.RegistrationDate);
        //}
        //var cart = _context.ShoppingCarts;
        //var shoppingCartToUserEmail = cart.Include(s => s.User);
        //foreach(var user in shoppingCartToUserEmail)
        //{
        ...
        // Then print each user's email and registration date to the console.
        //    var users = _context.Users;
        //   DateTime earlyDate = new DateTime(2016, 1, 1);
        //    DateTime latestDate = new DateTime(2018, 1, 1);
        //    var registeredAfter = users.Where(r => r.RegistrationDate > earlyDate);
        //    foreach(var user in registeredAfter)
        //    {
        ...
        /*        private void ProblemEight()
                {
                    ...
                    var usersShoppingCarts = _context.ShoppingCarts;
                    var userCarts = usersShoppingCarts.Include(u => u.User).Include(p=>p.Product);

                    foreach (var userCart in userCarts)
                    {                
                        if (userCart.User.Email == "afton@gmail.com")
                            Console.WriteLine($"Product name:\t{userCart.Product.Name}\nPrice:\t${userCart.Product.Price}\nAmount:\t{userCart.Quantity}\n\n");
                    }
        ...
        /*         private void ProblemNine()
                 {  
                    ...
                    var usersShoppingCarts = _context.ShoppingCarts;
                    var userCarts = usersShoppingCarts.Include(u => u.User).Where(e => e.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();

                    Console.WriteLine(userCarts);
